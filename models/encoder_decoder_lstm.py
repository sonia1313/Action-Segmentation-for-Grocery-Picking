...
class DecoderLSTM(torch.nn.Module):
    def __init__(self, hidden_size, n_layers, dropout, n_classes=6):
        super().__init__()
        self.input_size = 1
        self.hidden_size = hidden_size
        self.n_classes = n_classes
...
class EncoderDecoderLSTM(nn.Module):
    def __init__(self, n_features, hidden_size, n_layers, dropout):
        ...
        self.encoder = EncoderLSTM(n_features=n_features, hidden_size=hidden_size, n_layers=n_layers, dropout=dropout)
        self.decoder = DecoderLSTM(hidden_size=hidden_size, n_layers=n_layers, dropout=dropout)
        # print(self.encoder.hidden_size)
        # print(self.decoder.hidden_size)
...
class LitEncoderDecoderLSTM(pl.LightningModule):
    def __init__(self, n_features, hidden_size, n_layers, dropout, exp_name, experiment_tracking=True):
        ...
        self.encoder_decoder_model = EncoderDecoderLSTM(n_features, hidden_size, n_layers, dropout)
    ...
    def test_step(self, batch, batch_idx):
        ...
        accuracy = self.test_acc(logits, y)  # remove the batch dimension
