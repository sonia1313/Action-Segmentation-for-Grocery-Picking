...
def get_dataset():
    ...
    with open('data/tactile/with_feature_engineering/5fps/5fps_clutter_tactile_df.pkl', 'rb') as f:
    ...
    torch.save((X_data,y_data), 'data/tactile/with_feature_engineering/5fps/clutter_5fps_dataset_tensors.pt')
    X, y = torch.load('data/tactile/with_feature_engineering/5fps/clutter_5fps_dataset_tensors.pt')
    print(X.shape)
    print(y.shape)
    print(X[0])
    print(y[0])
